...
"varying vec2 TexCoord;\n"
"void main(){\n"
	 "vec4 t = uniColor * texture2D(tex, TexCoord);\n"
	 "if(t.a == 0) discard;"
	 "gl_FragColor = t;"
"}\n"
"\n";
...
static const char *quadVSource = "#version 120\n"
STR(
attribute vec2 pos;
varying vec2 TexCoord;
)
...
static const char *quadFSource = "#version 120\n"
STR(
varying vec2 TexCoord;
uniform sampler2D tex;
...
"void main(){\n"
	...
	"if(t.r < 0.2) discard;\n"
	 "gl_FragColor = vec4(uniColor.x, uniColor.y, uniColor.z, t.r) ;\n"
...
"varying vec2 TexCoord;\n"
"void main(){\n"
	 "gl_Position = vec4((invViewport * vec2(pos.x,1-pos.y) * 2) - 1,-1,1);\n"
	//"Position_CamSpace = (proj * view * model * vec4(pos, 1)).xyz;\n"
	 //"gl_Position = vec4((invViewport * pos.xy * 2) - 1,-1,1);\n"
